...
This assistant leverages `antigravity`'s ability to use `AGENTS.md` files and the settings in `.gemini/settings.json` to provide persistent context, making interactions more efficient and accurate.
...
b.  **Set Context in Antigravity:** Configure the context paths in `.gemini/settings.json`:
